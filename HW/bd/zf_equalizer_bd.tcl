...
# module references:
# axis_splitter, mux, pilot_removal
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set axis_aclk [ create_bd_port -dir I -type clk -freq_hz 99999900 axis_aclk ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axis_splitter_0_m_axis0 [get_bd_intf_pins axis_splitter_0/m_axis0] [get_bd_intf_pins pilot_removal_0/s_axis]
  ...
  connect_bd_intf_net -intf_net pilot_removal_0_m_axis [get_bd_intf_pins mux_0/s_axis0] [get_bd_intf_pins pilot_removal_0/m_axis]
  connect_bd_intf_net -intf_net s_axis_0_1 [get_bd_intf_ports s_axis] [get_bd_intf_pins axis_splitter_0/s_axis]

  # Create port connections
  connect_bd_net -net aclk_0_1 [get_bd_ports axis_aclk] [get_bd_pins axis_splitter_0/axis_aclk] [get_bd_pins mux_0/axis_aclk] [get_bd_pins pilot_removal_0/axis_aclk]
  connect_bd_net -net aresetn_0_1 [get_bd_ports axis_aresetn] [get_bd_pins axis_splitter_0/axis_aresetn] [get_bd_pins mux_0/axis_aresetn] [get_bd_pins pilot_removal_0/axis_aresetn]
