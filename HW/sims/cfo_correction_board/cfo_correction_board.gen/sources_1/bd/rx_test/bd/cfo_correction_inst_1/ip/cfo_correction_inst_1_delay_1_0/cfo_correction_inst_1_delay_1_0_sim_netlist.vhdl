...
-- Command     : write_vhdl -force -mode funcsim -rename_top cfo_correction_inst_1_delay_1_0 -prefix
--               cfo_correction_inst_1_delay_1_0_ cfo_correction_inst_0_delay_1_0_sim_netlist.vhdl
-- Design      : cfo_correction_inst_0_delay_1_0
...
entity cfo_correction_inst_1_delay_1_0_delay is
  port (
...
end cfo_correction_inst_1_delay_1_0_delay;

architecture STRUCTURE of cfo_correction_inst_1_delay_1_0_delay is
  signal \active_counter[8]_i_1_n_0\ : STD_LOGIC;
  signal \active_counter[8]_i_3_n_0\ : STD_LOGIC;
  signal active_counter_reg : STD_LOGIC_VECTOR ( 8 downto 0 );
  ...
  signal \quiet_counter[6]_i_1_n_0\ : STD_LOGIC;
  signal \quiet_counter[6]_i_3_n_0\ : STD_LOGIC;
  signal quiet_counter_reg : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal r_flip_i_1_n_0 : STD_LOGIC;
  signal r_flip_reg_n_0 : STD_LOGIC;
  signal s_axis_tready_INST_0_i_2_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \active_counter[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \active_counter[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \active_counter[2]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \active_counter[7]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \active_counter[8]_i_2\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \counter[6]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of delay_valid_i_1 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \quiet_counter[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \quiet_counter[2]_i_1\ : label is "soft_lutpair7";
...
\active_counter[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFF80000000"
        ...
        port map (
      I0 => active_counter_reg(4),
      I1 => active_counter_reg(2),
      I2 => active_counter_reg(0),
      I3 => active_counter_reg(1),
      I4 => active_counter_reg(3),
      I5 => active_counter_reg(5),
      O => \plusOp__0\(5)
    );
\active_counter[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
      I0 => \active_counter[8]_i_3_n_0\,
      I1 => active_counter_reg(6),
      O => \plusOp__0\(6)
    );
\active_counter[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"D2"
    )
        port map (
      I0 => active_counter_reg(6),
      I1 => \active_counter[8]_i_3_n_0\,
      I2 => active_counter_reg(7),
      O => \plusOp__0\(7)
    );
\active_counter[8]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"01FF"
    )
        port map (
      I0 => \quiet_counter[6]_i_3_n_0\,
      I1 => p_0_in_0,
      I2 => quiet_counter_reg(6),
      I3 => delay_valid,
      O => \active_counter[8]_i_1_n_0\
    );
\active_counter[8]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"C6CC"
    )
        port map (
      I0 => active_counter_reg(7),
      I1 => active_counter_reg(8),
      I2 => \active_counter[8]_i_3_n_0\,
      I3 => active_counter_reg(6),
      O => \plusOp__0\(8)
    );
\active_counter[8]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\active_counter_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => axis_aclk,
      CE => p_0_in_0,
      D => \plusOp__0\(7),
      Q => active_counter_reg(7),
      R => \active_counter[8]_i_1_n_0\
    );
\active_counter_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => axis_aclk,
      CE => p_0_in_0,
      D => \plusOp__0\(8),
      Q => active_counter_reg(8),
      R => \active_counter[8]_i_1_n_0\
    );
...
\counter[9]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
delay_valid_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FC54"
    )
        port map (
...
\quiet_counter[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F1"
    )
        port map (
      I0 => quiet_counter_reg(6),
      I1 => \quiet_counter[6]_i_3_n_0\,
      I2 => p_0_in_0,
      O => \quiet_counter[6]_i_1_n_0\
    );
\quiet_counter[6]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\quiet_counter[6]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFFFFFFFFFF"
    )
        port map (
...
s_axis_tready_INST_0_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFEF"
        ...
        port map (
      I0 => active_counter_reg(0),
      I1 => active_counter_reg(7),
      I2 => active_counter_reg(8),
      I3 => active_counter_reg(2),
      I4 => active_counter_reg(1),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cfo_correction_inst_1_delay_1_0 is
  port (
    axis_aclk : in STD_LOGIC;
    axis_aresetn : in STD_LOGIC;
    s_axis_tdata : in STD_LOGIC_VECTOR ( 127 downto 0 );
  ...
  attribute NotValidForBitStream of cfo_correction_inst_1_delay_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of cfo_correction_inst_1_delay_1_0 : entity is "cfo_correction_inst_0_delay_1_0,delay,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of cfo_correction_inst_1_delay_1_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of cfo_correction_inst_1_delay_1_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of cfo_correction_inst_1_delay_1_0 : entity is "delay,Vivado 2022.1";
end cfo_correction_inst_1_delay_1_0;

architecture STRUCTURE of cfo_correction_inst_1_delay_1_0 is
...
begin
inst: entity work.cfo_correction_inst_1_delay_1_0_delay
     port map (
      axis_aclk => axis_aclk,
