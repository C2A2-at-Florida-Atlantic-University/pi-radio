...
-- Command     : write_vhdl -force -mode funcsim -rename_top cfo_correction_inst_1_cp_rm2_0_0 -prefix
--               cfo_correction_inst_1_cp_rm2_0_0_ cfo_correction_inst_0_cp_rm2_0_0_sim_netlist.vhdl
...
entity cfo_correction_inst_1_cp_rm2_0_0_cp_rm2 is
  port (
...
end cfo_correction_inst_1_cp_rm2_0_0_cp_rm2;

architecture STRUCTURE of cfo_correction_inst_1_cp_rm2_0_0_cp_rm2 is
  signal \cp_counter[7]_i_4_n_0\ : STD_LOGIC;
  signal cp_counter_reg : STD_LOGIC_VECTOR ( 7 downto 6 );
  ...
  signal r_tvalid_reg_n_0 : STD_LOGIC;
  signal r_tvalid_rising : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \cp_counter[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \cp_counter[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \cp_counter[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \cp_counter[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \cp_counter[6]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \cp_counter[7]_i_3\ : label is "soft_lutpair1";
begin
\cp_counter[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\cp_counter[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\cp_counter[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\cp_counter[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
...
\cp_counter[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
\cp_counter[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\cp_counter[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\cp_counter[7]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\cp_counter[7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\cp_counter[7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\cp_counter[7]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\cp_counter_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => axis_aclk,
      CE => ltOp,
      D => plusOp(0),
...
\cp_counter_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => axis_aclk,
      CE => ltOp,
      D => plusOp(1),
...
\cp_counter_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => axis_aclk,
      CE => ltOp,
      D => plusOp(2),
...
\cp_counter_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => axis_aclk,
      CE => ltOp,
      D => plusOp(3),
...
\cp_counter_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => axis_aclk,
      CE => ltOp,
      D => plusOp(4),
...
\cp_counter_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => axis_aclk,
      CE => ltOp,
      D => plusOp(5),
...
\cp_counter_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => axis_aclk,
      CE => ltOp,
      D => plusOp(6),
...
\cp_counter_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => axis_aclk,
      CE => ltOp,
      D => plusOp(7),
...
r_tvalid_reg: unisim.vcomponents.FDRE
     port map (
      C => axis_aclk,
      CE => '1',
      D => s_axis_tvalid,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity cfo_correction_inst_1_cp_rm2_0_0 is
  port (
    axis_aclk : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of cfo_correction_inst_1_cp_rm2_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of cfo_correction_inst_1_cp_rm2_0_0 : entity is "cfo_correction_inst_0_cp_rm2_0_0,cp_rm2,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of cfo_correction_inst_1_cp_rm2_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of cfo_correction_inst_1_cp_rm2_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of cfo_correction_inst_1_cp_rm2_0_0 : entity is "cp_rm2,Vivado 2022.1";
end cfo_correction_inst_1_cp_rm2_0_0;

architecture STRUCTURE of cfo_correction_inst_1_cp_rm2_0_0 is
...
begin
inst: entity work.cfo_correction_inst_1_cp_rm2_0_0_cp_rm2
     port map (
      axis_aclk => axis_aclk,
