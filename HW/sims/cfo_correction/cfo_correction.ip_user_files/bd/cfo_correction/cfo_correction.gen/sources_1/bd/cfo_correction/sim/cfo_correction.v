...
module Mixer_imp_1KVXAAW
  ...
  cfo_correction_conj_0_0 conj_0
  ...
  cfo_correction_mixer_0_0 mixer_0
       (.axis_aclk(s_axis_aclk_0_1),
        .axis_aresetn(s_axis_aresetn_0_1),
...
(* CORE_GENERATION_INFO = "cfo_correction,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=cfo_correction,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=22,numReposBlks=21,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=17,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "cfo_correction.hwdef" *) 
module cfo_correction
   (axis_aclk,
    axis_aresetn,
    bypass,
    m_axis_tdata,
    ...
    s_axis_tuser,
    s_axis_tvalid);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.AXIS_ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.AXIS_ACLK, ASSOCIATED_BUSIF s_axis:m_axis, ASSOCIATED_RESET axis_aresetn, CLK_DOMAIN cfo_correction_axis_aclk, FREQ_HZ 249997498, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input axis_aclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.AXIS_ARESETN RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.AXIS_ARESETN, INSERT_VIP 0, POLARITY ACTIVE_LOW" *) input axis_aresetn;
  input bypass;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis, CLK_DOMAIN cfo_correction_axis_aclk, FREQ_HZ 249997498, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [127:0]m_axis_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis, CLK_DOMAIN cfo_correction_axis_aclk, FREQ_HZ 249997498, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 0, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 8, TUSER_WIDTH 8" *) input [127:0]s_axis_tdata;
  ...
  cfo_correction_angle_0_0 angle_0
       (.axis_aclk(s_axis_aclk_0_1),
        .axis_aresetn(s_axis_aresetn_0_1),
  ...
  cfo_correction_axis_splitter_0_0 axis_splitter_0
       (.axis_aclk(s_axis_aclk_0_1),
        .axis_aresetn(s_axis_aresetn_0_1),
  ...
  cfo_correction_axis_splitter_1_0 axis_splitter_1
       (.axis_aclk(s_axis_aclk_0_1),
        .axis_aresetn(s_axis_aresetn_0_1),
  ...
  cfo_correction_complex_mult_0_0 complex_mult_0
       (.axis_aclk(s_axis_aclk_0_1),
        .axis_aresetn(s_axis_aresetn_0_1),
  ...
  cfo_correction_conj_0_1 conj_0
       (.axis_aclk(s_axis_aclk_0_1),
        .axis_aresetn(s_axis_aresetn_0_1),
  ...
  cfo_correction_cp_rm_0_0 cp_rm_0
       (.axis_aclk(s_axis_aclk_0_1),
        .axis_aresetn(s_axis_aresetn_0_1),
  ...
  cfo_correction_delay_0_0 delay_0
       (.axis_aclk(s_axis_aclk_0_1),
        .axis_aresetn(s_axis_aresetn_0_1),
        .i_symbol(cp_rm_0_o_symbol),
  ...
  cfo_correction_scale_0_0 scale_0
       (.axis_aclk(s_axis_aclk_0_1),
        .axis_aresetn(s_axis_aresetn_0_1),
        .i_symbol(cp_rm_0_o_symbol),
  ...
  cfo_correction_tlast_symbol_0_0 tlast_symbol_0
       (.axis_aclk(s_axis_aclk_0_1),
        .axis_aresetn(s_axis_aresetn_0_1),
  ...
  cfo_correction_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(scale_0_o_negative_freq),
        .Res(util_vector_logic_0_Res));
  cfo_correction_xlconstant_0_0 xlconstant_0
