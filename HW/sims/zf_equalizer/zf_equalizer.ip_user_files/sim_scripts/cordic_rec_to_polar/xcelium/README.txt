...
#
# Generated by export_simulation on Tue Feb 28 20:53:05 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './cordic_rec_to_polar.sh' script.

./cordic_rec_to_polar.sh -reset_run
...
./cordic_rec_to_polar.sh -noclean_files

For more information on the script, please type './cordic_rec_to_polar.sh -help'.
