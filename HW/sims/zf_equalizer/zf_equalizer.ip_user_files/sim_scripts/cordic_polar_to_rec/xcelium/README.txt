...
#
# Generated by export_simulation on Tue Feb 28 21:00:58 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './cordic_polar_to_rec.sh' script.

./cordic_polar_to_rec.sh -reset_run
...
./cordic_polar_to_rec.sh -noclean_files

For more information on the script, please type './cordic_polar_to_rec.sh -help'.
