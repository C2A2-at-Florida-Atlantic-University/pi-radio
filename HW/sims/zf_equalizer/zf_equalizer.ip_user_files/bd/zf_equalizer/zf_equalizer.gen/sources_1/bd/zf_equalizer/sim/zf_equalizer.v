...
module Normalized_ZF_stage_1_imp_11U26K1
  ...
  wire aclk_1;
  wire aresetn_1;
  wire [31:0]average_0_m_axis_TDATA;
  wire average_0_m_axis_TLAST;
  wire average_0_m_axis_TVALID;
  wire [127:0]axis_data_fifo_0_M_AXIS_TDATA;
  wire axis_data_fifo_0_M_AXIS_TLAST;
  wire axis_data_fifo_0_M_AXIS_TREADY;
  wire axis_data_fifo_0_M_AXIS_TVALID;
  wire [31:0]channel_estimate_0_m_axis_TDATA;
  ...
  zf_equalizer_average_0_0 average_0
       (.axis_aclk(aclk_1),
        .axis_aresetn(aresetn_1),
        .m_axis_tdata(average_0_m_axis_TDATA),
        .m_axis_tlast(average_0_m_axis_TLAST),
        .m_axis_tvalid(average_0_m_axis_TVALID),
        .s_axis_tdata(channel_estimate_0_m_axis_TDATA),
        .s_axis_tlast(channel_estimate_0_m_axis_TLAST),
        .s_axis_tvalid(channel_estimate_0_m_axis_TVALID));
  zf_equalizer_axis_data_fifo_0_0 axis_data_fifo_0
       (.m_axis_tdata(axis_data_fifo_0_M_AXIS_TDATA),
        ...
        .s_axis_tdata(pilot_removal_0_m_axis_TDATA),
        .s_axis_tlast(pilot_removal_0_m_axis_TLAST),
        .s_axis_tvalid(pilot_removal_0_m_axis_TVALID));
  ...
  zf_equalizer_delay_0_0 delay_0
       (.axis_aclk(aclk_1),
        .axis_aresetn(aresetn_1),
        .i_symbol(pilot_removal_0_o_valid_frame),
  ...
  zf_equalizer_equalization_0_0 equalization_0
       (.axis_aclk(aclk_1),
        .axis_aresetn(aresetn_1),
        .s_ch_est_axis_tdata(average_0_m_axis_TDATA),
        .s_ch_est_axis_tlast(average_0_m_axis_TLAST),
        .s_ch_est_axis_tvalid(average_0_m_axis_TVALID),
        .s_din_axis_tdata(delay_0_m_axis_TDATA),
        .s_din_axis_tlast(delay_0_m_axis_TLAST),
        .s_din_axis_tvalid(delay_0_m_axis_TVALID));
...
module zf_equalizer
   (aclk,
    ...
    s_axis_tuser,
    s_axis_tvalid);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF m_axis:s_axis:s_axi, ASSOCIATED_RESET aresetn, CLK_DOMAIN zf_equalizer_axis_aclk, FREQ_HZ 249997498, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.ARESETN RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.ARESETN, INSERT_VIP 0, POLARITY ACTIVE_LOW" *) input aresetn;
  input bypass;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis, CLK_DOMAIN zf_equalizer_axis_aclk, FREQ_HZ 249997498, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [127:0]m_axis_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 s_axi " *) input [11:0]s_axi_awaddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis, CLK_DOMAIN zf_equalizer_axis_aclk, FREQ_HZ 249997498, HAS_TKEEP 0, HAS_TLAST 1, HAS_TREADY 0, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 8, TUSER_WIDTH 8" *) input [127:0]s_axis_tdata;
  ...
  zf_equalizer_mux_0_0 mux_0
       (.axis_aclk(aclk_0_1),
        ...
        .s_axis0_tdata({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .s_axis0_tid({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .s_axis0_tlast(1'b0),
        .s_axis0_tuser({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .s_axis0_tvalid(1'b0),
        .s_axis1_tdata(axis_splitter_0_m_axis1_TDATA),
