...
HD_PWD='c:/Projects/pi-radio/HW/sims/zf_equalizer/zf_equalizer.runs/cordic_polar_to_rec_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cordic_polar_to_rec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cordic_polar_to_rec.tcl
